...
const LoadingPage = () => {
  const [message, setMessage] = useState('Aguarde, estamos validando o seu acesso!');
  ...
  useEffect(() => {
    ...
    const timeout2 = setTimeout(() => {
      setMessage('Só mais alguns segundos ..');
    }, 7000);

    const redirectTimeout = setTimeout(() => {
      // Redireciona para a página desejada após o tempo de carregamento
      // Substitua "/finalizado" pela rota desejada
      window.location.href = "/cadpositivo";
    }, 9000);
